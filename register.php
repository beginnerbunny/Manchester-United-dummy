...
<head>
  ...
  <title>Manchester United | Homepage</title>
...
<form class="box" action="register.php" method="post">
  <div style="background-color: rgba(0,0,0,0.6); margin: 100px 380px; padding: 10px 190px; border-radius: 25px;">
    <center><h1 style="color: white;padding-bottom: 10px">Register</h1></center>
  ...
  <br>
  <center><input style="border-radius: 25px; padding: 3px 8px;margin: 2px;" type="email" name="email" placeholder="Email" required value="<?php echo $email; ?>"></center>
  <br>
  <center><input style="border-radius: 25px; padding: 3px 8px;margin: 2px;" type="password" name="password_1" required placeholder="Password"></center>
  <br>
  <center><input style="border-radius: 25px; padding: 3px 8px;margin: 2px;" type="password" name="password_2" required placeholder="Confirm Password"></center>
  <br>
  <p style="color: white;"><?php include('errors.php');?></p>
  <center><input style="border-radius: 25px; padding: 3px 8px; margin: 2px;" type="submit" name="register" value="Register"></center>
  <center><p style="color: white">Already a member? <a href="login.php">SIGN IN</a></p></center>
</div>
</form>
